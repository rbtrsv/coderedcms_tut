...
class CupcakesPage(CoderedWebPage):
    ...
    photo = models.ForeignKey(
        ...
        # I assume that "get_image_model_string" won’t have a backwards relation to this CupcakesPage model.
        related_name='+',
    ...
    # We are telling it to allow for the standard CMS page builder blocks as well as our custom fields.
    body_content_panels = CoderedWebPage.body_content_panels + [
